...
**2g.** With your new simulations from part f, present the 5-number summary of each column in both matrices in a single table. Be sure to label the rows and columns of the table. Qhat differences do you notice in the 5-number summaries between your matrix with $100$ rows and your matrix with $100,000$ rows? 
