...
(*Hint: use the parameter `main` to change the title of your histogram*)
...
**1f.** I simulated from an unknown distribution and obtained a value of 13.86. What is the percentile of my simulution in the *observed* distribution of your simulations? If you standardize my simulation (using the same mean and standard deviation as in part c!), what is the percentile of my simulation in the distribution of your standardized simulations? What do you notice about these two quantities?
...
**2g.** With your new simulations from part f, present the 5-number summary of each column in both matrices in a single table. Be sure to label the rows and columns of the table. What differences do you notice in the 5-number summaries between your matrix with $100$ rows and your matrix with $100,000$ rows? 

(*Hint: Use the function* `summary()`. *There are many ways you can present this table. Personally, my table would have 8 rows and 5 columns.*)
