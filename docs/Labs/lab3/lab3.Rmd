...
$$
Note that within the brackets of the right-hand side is a matrix and $[i,i]$ represents the element of the matrix located at the $i$<sup>th</sup> row and $i$<sup>th</sup> column indices. 
