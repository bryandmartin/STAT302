...
subtitle: "Software Development: Unit Testing, Automated Testing, and Packages"
author: "Bryan Martin"
date: ""
output:
...
# Step 8: Set up a GitHub Actions (*)
...
# Step 9: Set up tests in your package (*)
...
2. Push your local changes to GitHub using instructions from Lecture Slide 7.
...
Now go to your GitHub repository and click on the GitHub Action indicator. What is happening?
...
# Bonus slides for your convenience
---
