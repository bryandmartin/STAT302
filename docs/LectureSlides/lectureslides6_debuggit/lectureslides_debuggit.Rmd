...
4. Public or Private. If private, you **must** add both `bryandmartin` and the grader as collaborators (I will post the grader's GitHub account).
...
Don't forget, if you created a private repository, be sure to add both `bryandmartin` and the grader as collaborators.
